...
public class Tasks {
    ...
    private static final String newPost =
            "{'task':'newPost', 'currentUserId':'%s', 'caption':'%s'}";
    ...
    public static String getNewPostTask(String currentUserId, String caption) {
        return (String.format(newPost, currentUserId, caption));
    }
